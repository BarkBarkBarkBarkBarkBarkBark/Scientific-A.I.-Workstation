...
def system_prompt() -> str:
    return (
        ...
        "- If the user asks about the vector store / embeddings / 'what's in the RAG DB':\n"
        "  - First call vector_store_stats() (read-only) to confirm data is present.\n"
        "  - For semantic retrieval, use vector_search(query=..., top_k=...) (approval-gated by default; may incur embedding cost; can be auto-approved via SAW_AUTO_APPROVE_VECTOR_SEARCH=1).\n"
        "\n"
