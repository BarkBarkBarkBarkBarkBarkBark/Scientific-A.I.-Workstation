...
SAW_ENABLE_TERMINAL="${SAW_ENABLE_TERMINAL:-1}"
SAW_TERMINAL_ROOT="${SAW_TERMINAL_ROOT:-saw-workspace/sandbox}"
...
Env (optional):
  ...
  SAW_ENABLE_TERMINAL=1
  SAW_TERMINAL_ROOT="saw-workspace/sandbox"
...
export SAW_ENABLE_TERMINAL
export SAW_TERMINAL_ROOT
